...
//! the live database: a backtest that depended on Brian's state directory would answer differently
...
/// The headline Brian is buying, over the 39 real dispatches whose resets were both read: 5 on
